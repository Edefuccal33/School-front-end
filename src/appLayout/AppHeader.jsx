...
import { IconButton, Button, useColorMode, VStack, HStack, Box, Image, ButtonGroup } from "@chakra-ui/react";
  ...
  return (
    <React.Fragment>
      <VStack w="100%" h="100px">
        <HStack w="100%" h="100%">
          <Box w="100px" style={{minWidth:"100px", maxWidth:"200px"}} h="100%" pt={4} pl={4} align="center">
          ...
          <Box w="95%" h="100%" pt={7} pr={4} align="end">
          {isLogged ?
          ...
          :
            <div>
              <Button as={Link} to='/signin' color="pink.500" variant='ghost' leftIcon={<FaSignInAlt/>}>
                  Sign in
              </Button>
              <Button as={Link} to='/signup' ml={1} colorScheme='teal' variant='ghost' leftIcon={<FaPen/>}>
                  Sign up
              </Button>
            </div>
          }
